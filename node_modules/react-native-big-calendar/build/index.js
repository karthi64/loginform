...
function _CalendarBody(_a) {
    ...
    var _renderMappedEvent = React__namespace.useCallback(function (event, index) {
        return (React__namespace.createElement(CalendarEvent, { key: "".concat(index).concat(event.start).concat(event.title).concat(event.end), event: event, onPressEvent: onPressEvent, eventCellStyle: eventCellStyle, showTime: showTime, eventCount: isEventOrderingEnabled ? getCountOfEventsAtEvent(event, events) : undefined, eventOrder: isEventOrderingEnabled ? getOrderOfEvent(event, events) : undefined, overlapOffset: overlapOffset, renderEvent: renderEvent, ampm: ampm }));
    }, [
        ampm,
        eventCellStyle,
        events,
    ...
    return (React__namespace.createElement(React__namespace.Fragment, null,
        ...
        React__namespace.createElement(reactNative.ScrollView, __assign({ style: [
            ...
            React__namespace.createElement(reactNative.View, __assign({ style: [u['flex-1'], theme.isRTL ? u['flex-row-reverse'] : u['flex-row']] }, (reactNative.Platform.OS === 'web' ? panResponder.panHandlers : {})),
                !hideHours && (React__namespace.createElement(reactNative.View, { style: [u['z-20'], u['w-50']] }, hours.map(function (hour) { return (React__namespace.createElement(HourGuideColumn, { key: hour, cellHeight: cellHeight, hour: hour, ampm: ampm, hourStyle: hourStyle })); }))),
                dateRange.map(function (date) { return (React__namespace.createElement(reactNative.View, { style: [u['flex-1'], u['overflow-hidden']], key: date.toString() },
                    hours.map(function (hour, index) { return (React__namespace.createElement(HourGuideCell, { key: hour, cellHeight: cellHeight, date: date, hour: hour, onPress: _onPressCell, index: index, calendarCellStyle: calendarCellStyle })); }),
                    events
                        .filter(function (_a) {
                        var start = _a.start;
        ...
        date &&
            sortedEvents(date).reduce(function (elements, event, index, events) { return __spreadArray(__spreadArray([], elements, true), [
                index > maxVisibleEventCount ? null : index === maxVisibleEventCount ? (React__namespace.createElement(reactNative.Text, { key: index, style: [
                    ...
                    ] }, moreLabel.replace('{moreCount}', "".concat(events.length - maxVisibleEventCount)))) : (React__namespace.createElement(CalendarEventForMonthView, { key: index, event: event, eventCellStyle: eventCellStyle, onPressEvent: onPressEvent, renderEvent: renderEvent, date: date, dayOfTheWeek: ii, calendarWidth: calendarWidth, isRTL: theme.isRTL, eventMinHeightForMonthView: eventMinHeightForMonthView, showAdjacentMonths: showAdjacentMonths })),
            ], false); }, []))); }))); })));
}
...
function _CalendarHeader(_a) {
    ...
    return (React__namespace.createElement(reactNative.View, { style: [
        ...
        !hideHours && React__namespace.createElement(reactNative.View, { style: [u['z-10'], u['w-50'], borderColor] }),
        dateRange.map(function (date) {
            ...
            return (React__namespace.createElement(reactNative.TouchableOpacity, { style: [u['flex-1'], u['pt-2']], onPress: function () { return _onPressHeader(date.toDate()); }, disabled: onPressDateHeader === undefined, key: date.toString() },
                ...
                showAllDayEventCell ? (React__namespace.createElement(reactNative.View, { style: [
                    ...
                    return (React__namespace.createElement(reactNative.TouchableOpacity, { style: [eventCellCss.style, primaryBg, u['mt-2']], key: index, onPress: function () { return _onPressEvent(event); } },
                        React__namespace.createElement(reactNative.Text, { style: {
...
function _CalendarContainer(_a) {
    var events = _a.events, height = _a.height, hourRowHeight = _a.hourRowHeight, _b = _a.ampm, ampm = _b === void 0 ? false : _b, date = _a.date, eventCellStyle = _a.eventCellStyle, calendarCellStyle = _a.calendarCellStyle, calendarCellTextStyle = _a.calendarCellTextStyle, _c = _a.locale, locale = _c === void 0 ? 'en' : _c, _d = _a.hideNowIndicator, hideNowIndicator = _d === void 0 ? false : _d, _e = _a.mode, mode = _e === void 0 ? 'week' : _e, overlapOffset = _a.overlapOffset, _f = _a.scrollOffsetMinutes, scrollOffsetMinutes = _f === void 0 ? 0 : _f, _g = _a.showTime, showTime = _g === void 0 ? true : _g, _h = _a.headerContainerStyle, headerContainerStyle = _h === void 0 ? {} : _h, _j = _a.headerContentStyle, headerContentStyle = _j === void 0 ? {} : _j, _k = _a.dayHeaderStyle, dayHeaderStyle = _k === void 0 ? {} : _k, _l = _a.dayHeaderHighlightColor, dayHeaderHighlightColor = _l === void 0 ? '' : _l, _m = _a.weekDayHeaderHighlightColor, weekDayHeaderHighlightColor = _m === void 0 ? '' : _m, _o = _a.bodyContainerStyle, bodyContainerStyle = _o === void 0 ? {} : _o, _p = _a.swipeEnabled, swipeEnabled = _p === void 0 ? true : _p, _q = _a.weekStartsOn, weekStartsOn = _q === void 0 ? 0 : _q, onChangeDate = _a.onChangeDate, onPressCell = _a.onPressCell, onPressDateHeader = _a.onPressDateHeader, onPressEvent = _a.onPressEvent, renderEvent = _a.renderEvent, _r = _a.renderHeader, HeaderComponent = _r === void 0 ? CalendarHeader : _r, _s = _a.renderHeaderForMonthView, HeaderComponentForMonthView = _s === void 0 ? CalendarHeaderForMonthView : _s, _t = _a.weekEndsOn, weekEndsOn = _t === void 0 ? 6 : _t, _u = _a.maxVisibleEventCount, maxVisibleEventCount = _u === void 0 ? 3 : _u, _v = _a.eventMinHeightForMonthView, eventMinHeightForMonthView = _v === void 0 ? 22 : _v, activeDate = _a.activeDate, _w = _a.headerComponent, headerComponent = _w === void 0 ? null : _w, _x = _a.headerComponentStyle, headerComponentStyle = _x === void 0 ? {} : _x, _y = _a.hourStyle, hourStyle = _y === void 0 ? {} : _y, _z = _a.showAllDayEventCell, showAllDayEventCell = _z === void 0 ? true : _z, _0 = _a.moreLabel, moreLabel = _0 === void 0 ? '{moreCount} More' : _0, _1 = _a.showAdjacentMonths, showAdjacentMonths = _1 === void 0 ? true : _1, _2 = _a.sortedMonthView, sortedMonthView = _2 === void 0 ? true : _2, _3 = _a.hideHours, hideHours = _3 === void 0 ? false : _3, isEventOrderingEnabled = _a.isEventOrderingEnabled;
    var _4 = React__default["default"].useState(dayjs__default["default"](date)), targetDate = _4[0], setTargetDate = _4[1];
    React__default["default"].useEffect(function () {
        if (date) {
    ...
    var onSwipeHorizontal = React__default["default"].useCallback(function (direction) {
        ...
        if (onChangeDate) {
            var nextDateRange = getDateRange(nextTargetDate);
    ...
    if (mode === 'month') {
        ...
        return (React__default["default"].createElement(React__default["default"].Fragment, null,
            ...
            React__default["default"].createElement(CalendarBodyForMonthView, __assign({}, commonProps, { style: bodyContainerStyle, containerHeight: height, events: __spreadArray(__spreadArray([], daytimeEvents, true), allDayEvents, true), eventCellStyle: eventCellStyle, calendarCellStyle: calendarCellStyle, calendarCellTextStyle: calendarCellTextStyle, weekStartsOn: weekStartsOn, hideNowIndicator: hideNowIndicator, showAdjacentMonths: showAdjacentMonths, onPressCell: onPressCell, onPressDateHeader: onPressDateHeader, onPressEvent: onPressEvent, onSwipeHorizontal: onSwipeHorizontal, renderEvent: renderEvent, targetDate: targetDate, maxVisibleEventCount: maxVisibleEventCount, eventMinHeightForMonthView: eventMinHeightForMonthView, sortedMonthView: sortedMonthView, moreLabel: moreLabel }))));
    }
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        ...
        React__default["default"].createElement(CalendarBody, __assign({}, commonProps, { style: bodyContainerStyle, containerHeight: height, events: daytimeEvents, eventCellStyle: eventCellStyle, calendarCellStyle: calendarCellStyle, hideNowIndicator: hideNowIndicator, overlapOffset: overlapOffset, scrollOffsetMinutes: scrollOffsetMinutes, ampm: ampm, showTime: showTime, onPressCell: onPressCell, onPressEvent: onPressEvent, onSwipeHorizontal: onSwipeHorizontal, renderEvent: renderEvent, headerComponent: headerComponent, headerComponentStyle: headerComponentStyle, hourStyle: hourStyle, isEventOrderingEnabled: isEventOrderingEnabled }))));
}
...
var merge = require('merge-anything/dist/index.es').merge;
