 ...
 * **/
export default class PickDropdown extends Component {
    ...
    static propTypes = {
        ...
        imgFrameStyle:PropTypes.oneOfType([
            PropTypes.number,
            PropTypes.object,
            PropTypes.array
            //React.PropTypes.instanceOf(Message)
...
getStyle(style)
{
    this.styles = StyleSheetAdapt.getStyle(style == undefined ? this.props.style : style);
    return this.styles;
}
...
render() {
    ...
    const {disabled,textStyle,src,imgFrameStyle,imgStyle} = this.props;
