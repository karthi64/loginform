...
const styleConvertArrWidth = [
    "width", "padding","paddingLeft", "paddingRight", "marginLeft","marginRight",
    "left","right","fontSize"
];
...
const styleConvertArrHeight = [
    ...
    "borderRadius","borderTopLeftRadius", "borderBottomLeftRadius", "borderBottomRightRadius","borderTopRightRadius",
...
export default class StyleSheetAdapt{
    ...
    static isWH_scale = false;//是否按照宽高各自比例适配，默认false:按最小比列适配
    ...
    static getScale(){
        ...
        {
            let scl = Math.min(this.screen.width / designSize.width,this.screen.height / designSize.height);
            this.scale = {
                widthScale:scl,
                heightScale: scl,
            };
